...
This R Markdown file contains a brief overview of R Markdown files and
exmples of:
...
has a usefule [vignette](https://cran.r-project.org/web/packages/stargazer/vignettes/stargazer.pdf)).  
